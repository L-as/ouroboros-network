...
applyBlock :: forall m c l blk
            . ( ApplyBlock l blk, TableStuff l, Monad m, c
...
ledgerDbPush' :: (ApplyBlock l blk, TableStuff l, HasDiskDb Identity l)
...
ledgerDbPushMany' :: (ApplyBlock l blk, TableStuff l, HasDiskDb Identity l)
                  => LedgerDbCfg l
                  -> DbHandle l
...
ledgerDbSwitch' :: forall l blk
                 . (ApplyBlock l blk, TableStuff l, HasDiskDb Identity l)
                => LedgerDbCfg l
                -> DbHandle l
