                          ...
                          Just mutableConnState'  ->
                            if mutableConnState' == mutableConnState
                              then do
                                ...
                                --
                                -- If we are deleting the connState from the the state
                                -- then connState' can be TerminatingSt in which case we
                                -- are going to transition TerminatingSt -> TerminatedSt.
                                -- Otherwise, Connection Manager cleanup will take care of
                                -- tracing accordingly.
                                writeTVar connVar connState'
